...
from alignment_utils_masif_search import compute_nn_score, rand_rotation_matrix, \
       ...
       subsample_patch_coords, test_alignments_save
    ...
    for source_ix, source_pdb in enumerate(rand_list):
        ...
        if source_pdb == target_pdb:
            ...
            for j, res in enumerate(all_results):
                out_fn = "out/" + source_pdb + "_search/{}_{}_{}".format(source_pdb, j)
                rmsd, clashing, structure_coord_pcd, structure_coord_pcd_notTransformed = test_alignments_save(
                    out_fn,
                    res.transformation,
